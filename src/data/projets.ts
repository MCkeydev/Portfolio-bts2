        ...
        items: [
            ...
            },
            {
                ...
                context: {
                    role: 'Developeur Web',
                    entreprise: 'Linkweb, Agen - Alternance',
                    mission: `En prévision d'une fonctionnalité future nécessitant un système poussé de Drag and Drop, il m'a été demandé de développer à l'aide de la library de mon choix une fonctionnalité de glisser déposant pouvant être totalement récursive.`,
                },
                stack: [
                    { name: 'Typescript', icon: '/svg/typescript.svg' },
                    {
