...
L'application se compose d'une interface client développée en TypeScript (React), ainsi que d'une API serveur en PHP 8.1 (Symfony). Toutes les instructions d'installation sont disponibles dans le dossier documentaire téléchargeable ci-dessous, où vous trouverez également une description détaillée de la conception de l'application. Une documentation technique et une documentation utilisateur sont également incluses pour faciliter son utilisation.
            ...
            },
            {
                ...
                context: {
                    ...
                    Mission: "Afin d'améliorer la visibilité du centre ou j'ai pu effectuer mon BTS, il a été proposé à la promotion de BTS SIO SLAM et créer un site web pour l'établissement. Nous avons alors développé le site web de la formation, l'avons testé et ensuite déployé sur une serveur OVH. Est ensuite arrivé une phase de recette où il fallut effectuer les modificatiosn demandées par le client (le chef d'établissement).",
            ...
            },
            {
                ...
                context: {
                    Role: 'élève',
                    Contexte: 'Dans le cadre de ma formation',
                    Mission: "Afin de découvrir le logiciel de gestion de parc informatique GLPI ainsi qu'OCS, nous avons effectué ce TP qui consistait à explorer le patrimoine informatique d'un lycée recensé sur le logiciel, trier et mettre à disposition les données au formal tableur.",
                    tags: 'GLPI, OCS',
                },
