...
L'application se compose d'une interface client développée en TypeScript (React), ainsi que d'une API serveur en PHP 8.1 (Symfony). Toutes les instructions d'installation sont disponibles dans le dossier documentaire téléchargeable ci-dessous, où vous trouverez également une description détaillée de la conception de l'application. Une documentation technique et une documentation utilisateur sont également incluses pour faciliter son utilisation.
            ...
            {
                name: 'Prise en charge d\'incidents sur une application console en C# ',
                description: 'Application éducative de contrôle de connaissances en calcul',
                path: 'incident-logiciel',
                context: {
                    Role: 'developpeur',
                    Contexte: 'TP en cours de formation',
                    Mission: "Résoudre les incidents techniques, et effectuer une revue de code.",
                },
                tags: 'C#',

                download: '/downloads/incidents-logiciel.zip',
            },
            {
                name: 'Mise en place d\'un suivi de projet avec MsProject',
                description: ' WBS, ordonnancement, gestion des ressources, suivi du projet (projet sous MsProject) ',
                path: 'ms-project',
                context: {
                    Role: 'élève',
                    Contexte: 'TP en cours de formation',
                    Mission: "Création et gestion d'un projet ordonnancé sour le logiciel MSProject.",
                },
                tags: 'Microsoft project',
                download: '/downloads/gestion-projet.zip',
            },
            {
                name: 'Création, test et deploiement du site web du centre formation UFA47',
                description: "Développement, test et déploiement du site web d'une organisation",
                path: 'ufa47',
                context: {
                    Role: 'Developpeur web',
                    Contexte: 'Dans le cadre de ma formation',
                    Mission: "Afin d'améliorer la visibilité du centre de formation ou j'ai pu effectuer mon BTS, il a été proposé à la promotion de BTS SIO SLAM et créer un site web pour l'établissement. Nous avons alors développé le site web de la formation, l'avons testé et ensuite déployé sur une serveur OVH. Est ensuite arrivée une phase de recette où il fallut effectuer les modifications demandées par le client (le chef d'établissement).",
                },
                tags: 'JOOMLA, JS, HTML, CSS',
                thumbnail: '/images/ufa47.png',
                githublink: 'https://ufa47.info',
            },
            {
                name: 'Explorer le patrimoine informatique d\'un lycée et mettre à jour l\'inventaire avec le logiciel de gestion de parc GLPI  du contexte lycée',
                description: 'Documents Excel complétés avec les informations du parc informatique, scénario de test sur les groupes statiques et dynamiques d\'OCS, exportation d\'information au format CSV',
                path: 'ocsglpi',
                context: {
                    Role: 'élève',
                    Contexte: 'Dans le cadre de ma formation',
                    Mission: "Afin de découvrir le logiciel de gestion de parc informatique GLPI ainsi qu'OCS, nous avons effectué ce TP qui consistait à explorer le patrimoine informatique d'un lycée recensé sur le logiciel, trier et mettre à disposition les données au format tableur.",
                },
                tags: 'GLPI, OCS',
                thumbnail: '/images/glpi.png',
                download: '/downloads/OCSGLPI.zip',
            },
            {
                name: 'Gérer les habilitations d\'accès du logiciel de gestion de parc GLPI du\n' +
                    'contexte lycée',
                description: "Proposition d\'évolutions concernant la gestion d'habilitations\n" +
                    'dans GLPI',
                path: 'ocsglpi2',
                context: {
                    Role: 'élève',
                    Contexte: 'Dans le cadre de ma formation',
                    Mission: "Dans le cadre de la continuité des TPs précédents sur GLPI, il nous a été demandé de proposer une évolution de la gestion des habilitations dans le contexte d'un micro lycée.",
                },
                tags: 'GLPI',
                thumbnail: '/images/glpi.png',
                download: '/downloads/habilitations-glpi.zip',
            },
            {
                name: 'Rechercher l\'origine de pannes et corriger pour des imprimantes, des\n' +
                    'accès réseaux sur une maquette du contexte lycée',
                description: 'Maquette Packet Tracer corrigée, rapports d\'incident complétés',
                path: 'printer',
                context: {
                    Role: 'élève',
                    Contexte: 'Dans le cadre de ma formation',
                    Mission: "Afin de se familiariser avec les notions autour des systèmes et réseaux, ainsi que la résolution d'incidents sur ces derniers, nous avons effectué un TP où nous devions rechercher l'origine de pannes d'imprimantes sur un réseau, et les corriger. L'exercice se faisait sur une maquette Packet Tracer.",
                },
                tags: 'CISCO Packet Tracer',
                thumbnail: '/images/printer.png',
                download: '/downloads/incidents-imprimante.zip',
            },
            {
                name: 'Gérer les comptes, groupes et les accès aux dossiers partagés et des ressources sur le serveur Windows Server avec l\'annuaire Active Directory du contexte lycée',
                description: 'Proposition d\'organisation des OU, comptes, groupes, dossiers et habilitations d\'accès, compte-rendu de création OU, comptes, groupes, imprimante partagée et habilitations gérées',
                path: 'active-directory',
                context: {
                    Role: 'élève',
                    Contexte: 'Dans le cadre de ma formation',
                    Mission: "Dans le cadre d'un TP, nous avons pu créer des unités d'organisation, ainsi que des comptres groupes, sur lesquels nous avons crée des habilitations d'accès pour les imprimantes d'un micro-lycée.",
                },
                tags: 'Active Directory',
                thumbnail: '/images/AD.jpg',
                download: '/downloads/AD.zip',
            },
            {
                name: 'Mettre en place avec Debian un environnement Web modèle de test pour l\'équipe de développement du contexte lycée ',
                description: 'Compte-rendu de préparation des VM Debian type Web et Bdd',
                path: 'debian-web',
                context: {
                    Role: 'élève',
                    Contexte: 'Dans le cadre de ma formation',
                    Mission: "Dans la continuité des autres TP dans le context micro-lycée, il nous a été demandé de déployer un serveur web debian, ainsi qu'une base de données MySQL. Cet environnement est destiné à la pré-production d'une future application.",
                },
                tags: 'Active Directory',
                thumbnail: '/images/debian.gif',
                download: '/downloads/debian-web.zip',
            },
            {
                name: 'Déployer et tester la solution GLPI dans le réseau du contexte lycée ',
                description: 'Documentation technique de déploiement, documentation utilisateur pour les demandes d\'assistance',
                path: 'deploiement-glpi',
                context: {
                    Role: 'élève',
                    Contexte: 'Dans le cadre de ma formation',
                    Mission: "Dans la continuité des autres TP dans le context micro-lycée, il nous a été demandé de tester le déploiement de GLPI sur un serveur web, ainsi que de tester les accès à la base de données. Nous avons aussi dû produire une documentation utilisateur afin d'aider les professeurs à soumettre des rapports d'incidents.",
                },
                tags: 'GLPI',
                thumbnail: '/images/glpi.png',
                download: '/downloads/deploiement-glpi.zip',
            },
        ],
    },
    {
